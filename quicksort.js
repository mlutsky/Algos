...
const quickSort = array => {
  ...
  return (
    quickSort(array.slice(0, array.length - swaps - 1)) +
    [pivot] +
    quickSort(array.slice(array.length - swaps, array.length))
  );
};

const mergeSort = array => {
  // make sure to return the array in the case that length is 1
  if (array.length > 1) {
...
const merge = (array1, array2) => {
  if (!array1 && !array2) {
    ...
    // check to make sure we don't still have any left on either array
